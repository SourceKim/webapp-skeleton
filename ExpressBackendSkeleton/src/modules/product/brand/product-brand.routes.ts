...
router.post('/brands/admin', roleMiddleware(ADMIN_ROLE_NAMES), controller.create);
router.put('/brands/admin/:id', roleMiddleware(ADMIN_ROLE_NAMES), controller.update);
router.delete('/brands/admin/:id', roleMiddleware(ADMIN_ROLE_NAMES), controller.remove);
