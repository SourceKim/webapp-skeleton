<template>
  <el-popover trigger="click" :hideAfter="0" popper-style="min-width: 100px; width: auto;">
    <template #reference>
      <el-button type="primary" text icon="operation" class="action-btn">{{ $t('comp.table.colSort') }}</el-button>
    </template>
    <el-tree
      class="column-sort"
      ref="treeRef"
...
import type { TableSortColumn } from '@/components/interface/table'
